...
The project was created using Unity 5.5.2f1.
...
All the scripts in "Assets\BridgeSDK" are necessary. "BridgeSDKSampleWrapper.cs" (located in "Assets\Scripts") is just an example of how to use the plugin.
...
Please contact bridgesdk@logitech.com or reach us via GitHub if you have any question.